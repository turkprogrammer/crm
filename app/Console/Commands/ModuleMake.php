...
class ModuleMake extends Command {
     ...
     * @return void
     */
    public function __construct(Filesystem $filesystem) {//Filesystem injection
        parent::__construct();
    ...
    private function createApiRoutes(String $controller, String $modelName): void {
        ...
        if ($this->alreadyExists($routePath)) {
            ...
            /* @var $stub меняем временные строки */
            $stub = str_replace(
                    [
                        'DummyClass',
                        'DummyRoutePrefix',
